...
@NamedQueries({
    ...
    @NamedQuery(name = "FacturaProducto.findByPrecioVendido", query = "SELECT f FROM FacturaProducto f WHERE f.precioVendido = :precioVendido")})
public class FacturaProducto implements Serializable {
    ...
    public FacturaProducto(long idFactura, long idProducto) {
    ...
    public String toString() {
        return "peluposbd.FacturaProducto[ facturaProductoPK=" + facturaProductoPK + " ]";
    }
