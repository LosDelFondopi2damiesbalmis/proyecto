# Casos de uso principales de nuestro Programa

En la siguiente tabla se muestra los diferentes casos de uso de nuestra aplicación
...
|**Validar productos**|Comprobar los productos que se están vendiendo|Alta|
|**Comprobar estadísticas**|Pueden generar estadísticas de clientes y gastos|Baja|
|**Bloquear usuarios o eliminarlos**| Podrán eliminar cuentas de usuario de por ejemplo trabajadores que ya no trabajan ahí |Media|
