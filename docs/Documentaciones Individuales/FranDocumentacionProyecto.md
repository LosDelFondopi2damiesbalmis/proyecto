...
## 3️⃣ Alineación con los ODS

El proyecto TPV para Peluquerías contribuye a varios Objetivos de Desarrollo Sostenible (ODS) definidos por la ONU:
...
El repositorio del proyecto **TPV para Peluquería** sigue una estructura clara y modular que facilita la colaboración entre los miembros del equipo y la escalabilidad del sistema.

🔗 **Repositorio GitHub:** [https://github.com/LosDelFondopi2damiesbalmis/proyecto](https://github.com/LosDelFondopi2damiesbalmis/proyecto)
