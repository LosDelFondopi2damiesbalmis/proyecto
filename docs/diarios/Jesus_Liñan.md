...
**Nombre:** Jesus Manuel Liñan Almagro
...
|------------ | ------------------------- | ------------------------- | ------------------------- | ------------------------- | ------------------------- | -------------
|15/09| 1 | Perfil H.A.D.A | 20 minutos | - | - | -
|15/09| 1 | Reto malvavisco | 1 hora | - | - | -
|22/09| 2 | Git en local | 1,55h horas | - | - | -
|29/09| 1 | Git en VsCode | 55 minutos  | un poco confusa la gestion de distintas ramas | acostumbrarme | -
...
|30/10| 1 | diseñar la ui de escritorio | 1 hora | - | - | -
